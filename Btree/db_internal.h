 ...
 * 
 * $Id: db_internal.h,v 1.9 2002/06/23 10:28:06 chipx86 Exp $
 *
...
#if defined(_WINDOWS)
#define StringCompare		stricmp
#else
#define StringCompare		strcasecmp
#endif

#define MEM_CHECK_RET_ZERO(tmp) \
	if ((tmp) == NULL) { \
		btreeSetError("Error: Out of memory in %s, line %d", \
				__FILE__, __LINE__); \
		return 0; \
	}
