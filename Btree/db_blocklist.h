 ...
 * 
 * $Id: db_blocklist.h,v 1.3 2002/04/07 18:29:40 chipx86 Exp $
 *
...
/**
 * Offset of the BFree block list.
 */
#define DB_FREE_BLOCK_LIST_OFFSET DB_HEADER_BLOCK_SIZE

/**
 * Size of the BFree block list.
 */
 ...
 *
 * @return 1 if a BFree block list is found, or 0 otherwise.
 */
 ...
 * Frees a block list.
 *
 * @param blocks The block list to BFree.
 */
