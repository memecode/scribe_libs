 ...
 * 
 * $Id: offsetlist.c,v 1.6 2002/06/23 10:28:06 chipx86 Exp $
 *
...
olReadBlock(GdbBlock *block, const char *buffer, void *extra)
{
	...
	MEM_CHECK_RET_ZERO(list = (GdbOffsetList *)malloc(sizeof(GdbOffsetList)));
	...
	MEM_CHECK_RET_ZERO(list->offsets = (offset_t *)malloc(list->arraySize *
												 sizeof(offset_t)));
