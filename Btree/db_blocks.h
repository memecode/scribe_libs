 ...
 * 
 * $Id: db_blocks.h,v 1.15 2002/04/07 18:29:41 chipx86 Exp $
 *
...
typedef struct GdbBlock GdbBlock;
 ...
 *
 * @param block The block to BFree.
 */
 ...
 */
int gdbWriteBlock(GdbBlock *block);

/**
 * Reserves a chain of BFree blocks of the specified type.
 *
 * @param db        The active database.
 ...
 *
 * @param db        The active database.
 * @param chain     The chain of blocks to BFree.
...
/**
 * Reserves a BFree block of the specified type.
 *
 * @param db        The active database.
 * @param blockType The type of block.
 *
