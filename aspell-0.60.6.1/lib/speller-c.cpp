...
C_EXPORT CanHaveError * new_aspell_speller(Config * config)
{
...
C_EXPORT Speller * to_aspell_speller(CanHaveError * obj)
{
  return static_cast<Speller *>(obj);
}

C_EXPORT void delete_aspell_speller(Speller * ths)
{
  delete ths;
}

C_EXPORT unsigned int aspell_speller_error_number(const Speller * ths)
{
  return ths->err_ == 0 ? 0 : 1;
}

C_EXPORT const char * aspell_speller_error_message(const Speller * ths)
{
  return ths->err_ ? ths->err_->mesg : "";
}

C_EXPORT const Error * aspell_speller_error(const Speller * ths)
{
  return ths->err_;
}

C_EXPORT Config * aspell_speller_config(Speller * ths)
{
  return ths->config();
}

C_EXPORT int aspell_speller_check(Speller * ths, const char * word, int word_size)
{
...
C_EXPORT int aspell_speller_add_to_personal(Speller * ths, const char * word, int word_size)
{
  ths->temp_str_0.clear();
  ths->to_internal_->convert(word, word_size, ths->temp_str_0);
  unsigned int s0 = ths->temp_str_0.size();
...
C_EXPORT int aspell_speller_add_to_session(Speller * ths, const char * word, int word_size)
{
  ths->temp_str_0.clear();
  ths->to_internal_->convert(word, word_size, ths->temp_str_0);
  unsigned int s0 = ths->temp_str_0.size();
...
C_EXPORT const WordList * aspell_speller_personal_word_list(Speller * ths)
{
...
C_EXPORT const WordList * aspell_speller_session_word_list(Speller * ths)
{
...
C_EXPORT const WordList * aspell_speller_main_word_list(Speller * ths)
{
...
C_EXPORT int aspell_speller_save_all_word_lists(Speller * ths)
{
...
C_EXPORT int aspell_speller_clear_session(Speller * ths)
{
...
C_EXPORT const WordList * aspell_speller_suggest(Speller * ths, const char * word, int word_size)
{
  ths->temp_str_0.clear();
  ths->to_internal_->convert(word, word_size, ths->temp_str_0);
  unsigned int s0 = ths->temp_str_0.size();
...
C_EXPORT int aspell_speller_store_replacement(Speller * ths, const char * mis, int mis_size, const char * cor, int cor_size)
{
  ths->temp_str_0.clear();
